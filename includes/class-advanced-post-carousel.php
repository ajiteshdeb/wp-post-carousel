...
class Advanced_Post_Carousel {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Advanced_Post_Carousel_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'advanced-post-carousel';
		$this->version = '1.0.0';
	 ...
	 *
	 * - Advanced_Post_Carousel_Loader. Orchestrates the hooks of the plugin.
	 * - Advanced_Post_Carousel_i18n. Defines internationalization functionality.
	 * - Advanced_Post_Carousel_Admin. Defines all hooks for the admin area.
	 * - Advanced_Post_Carousel_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-advanced-post-carousel-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-advanced-post-carousel-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-advanced-post-carousel-admin.php';
	 ...
	 *
	 * Uses the Advanced_Post_Carousel_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Advanced_Post_Carousel_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Advanced_Post_Carousel_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Advanced_Post_Carousel_Loader    Orchestrates the hooks of the plugin.
	 */
